...
@section('content')
    <div class="row">
        <div class="col-12">
            <div class="card">
                <div class="card-body">
                    <h4 class="card-title">Table Komentar</h4>
        ...
        <div class="modal-dialog" role="document">
            <div class="modal-content">
                <div class="modal-header">
                    <h4 class="modal-title" id="exampleModalLabel1">Form Category Komentar-activity</h4>
...
@section('script')
    ...
    <script>
        $(document).ready(function() {
            window.page_url = window.base_url + `comment`;
            window.form = $('#form');
