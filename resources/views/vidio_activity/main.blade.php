@extends('layouts.app')
@section('page_title', 'Vidio')
@section('content')
    <div class="row">
        <div class="col-12">
            <div class="card">
                <div class="card-body">
                    <h4 class="card-title">Table Vidio</h4>
        ...
        <div class="modal-dialog" role="document">
            <div class="modal-content">
                <div class="modal-header">
                    <h4 class="modal-title" id="exampleModalLabel1">Form Category vidio-activity</h4>
                    <button type="button" class="close" data-dismiss="modal" aria-label="Close"><span
                            aria-hidden="true">&times;</span></button>
                </div>
                <div class="modal-body">
                    <form id="form" method="POST" action="{{ route('vidio-activity.store') }}">
                        <div class="form-group" field="name">
                            <label for="name" class="control-label">Nama:</label>
                            <input type="text" class="form-control" id="name" name="name">
                            <div class="error text-danger"></div>
                        </div>
                        <div class="form-group" field="youtube_embed">
                            <label for="youtube_embed" class="control-label">URL Embed:</label>
...
@section('script')
    ...
    <script>
        $(document).ready(function() {
            window.page_url = window.base_url + `vidio-activity`;
            window.form = $('#form');
